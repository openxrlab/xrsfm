...
void DrawFeatureMatches(const cv::Mat &img1, const cv::Mat &img2,
                        const std::vector<Eigen::Vector2d> &kpts1,
                        const std::vector<Eigen::Vector2d> &kpts2,
                        const std::vector<Match> &matches,
                        const std::vector<char> mask = std::vector<char>(0));
...
void DrawFeatureFlow(const cv::Mat &img1,
                     const std::vector<Eigen::Vector2d> &pts1,
                     const std::vector<Eigen::Vector2d> &pts2,
                     const std::vector<Match> &matches,
                     const std::vector<int> &states,
                     const std::string window_name = "feature flow");

void DrawCameras(const std::vector<Pose> &cameras,
                 const std::vector<Eigen::Vector3d> colors, double camera_size);
