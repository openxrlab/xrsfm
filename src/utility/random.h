 ...
 * @date 2018-09-05
 **/
#ifndef ITSLAM_RANDOM_H
#define ITSLAM_RANDOM_H
...
template <typename T> class UniformNoise : public _RandomBase {
  public:
...
template <typename T> class GaussianNoise : public _RandomBase {
  public:
    typedef T value_type;
...
template <typename T> class UniformInteger : public _RandomBase {
  public:
    typedef T value_type;
