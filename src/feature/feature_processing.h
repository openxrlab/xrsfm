...
void ExpansionAndMatching(
    Map &map, const std::map<int, std::vector<int>> &retrieval_rank_of_frames,
    const int num_iteration, const std::vector<ImageSize> &images,
    const size_t &ini_frame1, const size_t &ini_frame2, bool b_use_fundamental,
