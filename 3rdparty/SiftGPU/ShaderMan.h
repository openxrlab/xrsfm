...
class ShaderMan {
  ...
  public:
    ...
    static void UseShaderOrientation(int gtex, int width, int height,
                                     float sigma, int auxtex, float step,
                                     int keypoint_list);
    static void UseShaderDescriptor(int gtex, int otex, int dwidth, int fwidth,
                                    int width, int height, float sigma);
    static void UseShaderSimpleOrientation(int oTex, float sigma,
                                           float sigma_step);
    ...
    static void FilterImage(FilterProgram *filter, GLTexImage *dst,
                            GLTexImage *src, GLTexImage *tmp);
    static void TextureCopy(GLTexImage *dst, GLTexImage *src);
    static void TextureDownSample(GLTexImage *dst, GLTexImage *src,
                                  int scale = 2);
