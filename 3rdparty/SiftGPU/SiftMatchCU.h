...
private:
	int  GetBestMatch(int max_match, uint32_t match_buffer[][2], float distmax, float ratiomax, int mbm, int dim = 128);
public:
  ...
  bool Allocate(int max_sift, int mbm) override;
	...
	void SetDescriptors(int index, int num, const unsigned char * descriptor, int id = -1, int dim = 128);
	...
	int  GetSiftMatch(int max_match, uint32_t match_buffer[][2], float distmax, float ratiomax, int mbm, int dim = 128);
	int  GetGuidedSiftMatch(int max_match, uint32_t match_buffer[][2], float* H, float* F, float* E, int lengthHomo,
									 float distmax, float ratiomax, float hdistmax, float fdistmax, int mbm, int dim =128);
    //////////////////////////////
