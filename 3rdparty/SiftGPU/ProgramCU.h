...
//					It is basically a wrapper around all the
// CUDA kernels
//
...
class ProgramCU {
  ...
  public:
    ...
    static void ComputeKEY(CuTexImage *dog, CuTexImage *key, float Tdog,
                           float Tedge);
    ...
    static void ComputeOrientation(CuTexImage *list, CuTexImage *got,
                                   CuTexImage *key, float sigma,
                                   float sigma_step, int existing_keypoint);
    static void ComputeDescriptor(CuTexImage *list, CuTexImage *got,
                                  CuTexImage *dtex, int rect = 0,
                                  int stream = 0);

    // data conversion
    static void SampleImageU(CuTexImage *dst, CuTexImage *src, int log_scale);
    static void SampleImageD(CuTexImage *dst, CuTexImage *src,
                             int log_scale = 1);
    static void ReduceToSingleChannel(CuTexImage *dst, CuTexImage *src,
                                      int convert_rgb);
    ...
    static void DisplayConvertKEY(CuTexImage *key, CuTexImage *dog,
                                  CuTexImage *out);
