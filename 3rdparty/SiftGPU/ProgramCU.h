...
public:
	...
	//SIFTMATCH FUNCTIONS
	static void MultiplyDescriptor(CuTexImage* tex1, CuTexImage* tex2, CuTexImage* texDot, CuTexImage* texCRT,int dim = 128);
	static void MultiplyDescriptorG(CuTexImage* texDes1, CuTexImage* texDes2,
		...
		float* H, int lengthHomo, float hdistmax, float* F, float fdistmax, float* E, int dim =128);
	static void GetRowMatch(CuTexImage* texDot, CuTexImage* texMatch, float distmax, float ratiomax, int dim = 128);
	static void GetColMatch(CuTexImage* texCRT, CuTexImage* texMatch, float distmax, float ratiomax, int dim = 128);
};
