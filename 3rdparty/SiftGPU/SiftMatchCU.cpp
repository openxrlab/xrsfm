...
void SiftMatchCU::SetDescriptors(int index, int num,
                                 const unsigned char* descriptors, int id, int dim) {
...
int SiftMatchCU::GetGuidedSiftMatch(int max_match, uint32_t match_buffer[][2],
                                    float* H, float* F, float* E, int lengthHomo, 
                                    float distmax, float ratiomax, 
                                    float hdistmax, float fdistmax, int mbm, int dim) {
  ...
  ProgramCU::MultiplyDescriptorG(_texDes, _texDes + 1, _texLoc, _texLoc + 1,
                                 &_texDot, (mbm ? &_texCRT : NULL), H, lengthHomo, hdistmax,
                                 F, fdistmax, E, dim);
