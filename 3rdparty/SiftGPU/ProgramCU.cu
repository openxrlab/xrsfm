...
void __global__ MultiplyDescriptor_Kernel(int* d_result, int num1, int num2, int3* d_temp, int dim)
{
...
void __global__ MultiplyDescriptorG_Kernel_E(int* d_result, int num1, int num2, int3* d_temp,
...
void __global__ MultiplyDescriptorG_Kernel_F(int* d_result, int num1, int num2, int3* d_temp,
		...
		float* H, int lengthHomo, float hdistmax, float* F, float fdistmax, float* E, int dim)
{
	if (F != NULL) {
		...
		des1->BindTexture(texDes1);
		des2->BindTexture(texDes2);
		MultiplyDescriptorG_Kernel_F<<<grid, block>>>((int*)texDot->_cuData, num1, num2,
		...
		des1->BindTexture(texDes1);
		des2->BindTexture(texDes2);
		MultiplyDescriptorG_Kernel_E<<<grid, block>>>((int*)texDot->_cuData, num1, num2,
													(texCRT? (int3*)texCRT->_cuData : NULL),
