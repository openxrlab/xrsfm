...
/////////////////////////////////////////////////////////////////////////////
// class SiftPyramid
// description: virtual class of SIFT data pyramid
//			   provides functions for SiftPU to run steps of GPU
// SIFT 			   class PyramidNaive is the first
// implementation class PyramidPacked is a better OpenGL implementation
...
class SiftPyramid : public GlobalUtil {
  ...
  public:
    ...
    virtual void SetKeypointList(int num, const float *keys, int run_on_current,
    ...
    inline void GetPyramidTiming(float *timing) {
        for (int i = 0; i < 8; i++)
            timing[i] = _timing[i];
    }
