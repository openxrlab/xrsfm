...
CuTexImage::CuTexObj::~CuTexObj() { cudaDestroyTextureObject(handle); }

CuTexImage::CuTexObj
CuTexImage::BindTexture(const cudaTextureDesc &textureDesc,
    ...
    cudaCreateTextureObject(&texObj.handle, &resourceDesc, &textureDesc,
                            nullptr);
...
CuTexImage::CuTexObj
CuTexImage::BindTexture2D(const cudaTextureDesc &textureDesc,
                          const cudaChannelFormatDesc &channelFmtDesc) {
    CuTexObj texObj;
